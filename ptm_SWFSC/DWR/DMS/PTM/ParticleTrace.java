...
public class ParticleTrace {
	 ...
	 */
	public final int getNumberOfTraces() {
		return traceNumber;
	};
	...
	public String toString() {
		...
		for (int i = 1; i < getNumberOfTraces(); i++) {
			rep += "@Time " + getTime(i) + " @Node " + getNodeId(i) + " @Channel " + getWaterbodyId(i) + "\n";
		}
		return rep;
	}
	...
	/**
	 * resets the trace number while keeping the memory allocated in each of the arrays. This helps conserve time in multiple file sweeps in case of

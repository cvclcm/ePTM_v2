...
public class Reservoir extends Waterbody {
	 ...
	 */
	public Reservoir(int nId, int hId, String wbName, float resArea, float botelv, int[] nodeArray) {
	 ...
	 */
	public final float getVolumeOutflow(int nodeId, float timeStep, float tmLeft) {
		float flow;
	...
	public final void setDepth(float[] depthArray, int timeStepIndex) {
		depthAt[0][timeStepIndex] = depthArray[0];
	}
